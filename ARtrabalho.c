...
//versao interativa
//encotar o elemento correspondente ao ISBN dado
      ...
      case 1:
       ...
       case 2:
          ...
          printf("Introduza O ISBN do Elemento\n");
              scanf("%d",&X.ISBN); 
                  Num=X.ISBN;
                  //LI=ElementoIgual_Rec(); 
                      LI=ElementoIgual(Num,T);
              //Num=X.ISBN;
              // T->Elemento.ISBN=Num;
              //printf("Introduza O ISBN %d do Elemento1\n",T->Elemento.ISBN);
              //printf("Introduza O ISBN %d do Elemento2\n",Num);
              //printf("Introduza O ISBN %d do Elemento2\n",LI);
              //printf("Introduza O ISBN %d do Elemento3\n",T->Elemento);
              //printf("O numero de el. maiores quer: %d ",Num);
              //MostrarElemento(T->Elemento);
               //T->Elemento=T->Elemento.ISBN;
              P=RemoverABP (T,LI);
              ListarElementos(P);
           break;
       case 3:
